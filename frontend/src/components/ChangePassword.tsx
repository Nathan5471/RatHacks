    ...
    <div className="flex flex-col w-80">
      ...
      <form className="flex flex-col" onSubmit={handleUpdatePassword}>
        ...
        <div className="flex flex-row w-full">
          <button
            type="submit"
            className="mt-4 bg-primary-a0 hover:bg-primary-a1 spooky:bg-spooky-a0 spooky:hover:bg-spooky-a1 space:bg-space-a0 space:hover:bg-space-a1 p-2 rounded-lg w-full font-bold"
          >
            Change Password
          </button>
          <button
