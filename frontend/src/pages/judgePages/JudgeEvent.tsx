      ...
      <div className="relative w-screen h-screen flex flex-col sm:flex-row bg-surface-a0 text-white">
        ...
        <div className="flex flex-col ml-6 md:ml-0 w-[calc(100%-1.5rem)] md:w-4/5 lg:w-5/6 h-full overflow-y-auto p-4 items-center">
          ...
          <div className="flex flex-col items-center mt-20 bg-surface-a1 p-6 rounded-lg">
            ...
            <Link
              to="/app/judge/events"
              className="mt-4 w-45 bg-primary-a0 hover:bg-primary-a1 spooky:bg-spooky-a0 spooky:hover:bg-spooky-a1 p-2 rounded-lg font-bold text-center"
            >
              Back to Events
            </Link>
          </div>
                ...
                {filteredProjects.map((project) => (
                  ...
                  >
                    ...
                    <Link
                      ...
                      className="bg-primary-a0 hover:bg-primary-a1 spooky:bg-spooky-a0 spooky:hover:bg-spooky-a1 p-2 rounded-lg font-bold text-center"
                    >
