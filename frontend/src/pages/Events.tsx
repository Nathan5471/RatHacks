                    ...
                    {event.status === "upcoming" &&
                      (user && user.events.includes(event.id) ? (
                        ...
                        <button
                          ...
                          className="bg-primary-a0 hover:bg-primary-a1 spooky:bg-spooky-a0 spooky:hover:bg-spooky-a1 space:bg-space-a0 space:hover:bg-space-a1 p-2 ml-2 rounded-lg font-bold w-full"
                        >
                          Join
                        </button>
                      ))}
