              ...
              <div className="flex flex-col mt-4 bg-surface-a1 p-4 rounded-lg">
                ...
                <div className="flex flex-row w-full justify-center">
                  <div className="flex flex-col bg-surface-a2 rounded-lg w-25 sm:w-30 p-2 sm:p-4 mx-2">
                    <span className="text-5xl font-bold text-primary-a0 spooky:text-spooky-a0 space:text-space-a0 text-center">
                    ...
                    {!event.team.submittedProject && (
                      ...
                      >
                        ...
                        <div className="flex flex-row">
                          <button
                            type="submit"
                            className="bg-primary-a0 hover:bg-primary-a1 spooky:bg-spooky-a0 spooky:hover:bg-spooky-a1 space:bg-space-a0 space:hover:bg-space-a1 p-2 rounded-lg font-bold mt-2 w-full"
                          >
                            Join Team
                          </button>
                          <button
