...
export default function Login() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen w-screen bg-surface-a0 text-white">
      ...
      >
        <h1 className="text-4xl font-bold text-center mb-4 text-primary-a0 spooky:text-spooky-a0">
          Login
        </h1>
        ...
        <button
          type="submit"
          className="bg-primary-a0 hover:bg-primary-a1 spooky:bg-spooky-a0 spooky:hover:bg-spooky-a1 p-2 mt-4 rounded-lg"
        >
          Login
        </button>
