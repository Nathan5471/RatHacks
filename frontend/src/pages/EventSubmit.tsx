      ...
      <div className="relative w-screen h-screen flex flex-col sm:flex-row bg-surface-a0 text-white">
        ...
        <div className="flex flex-col ml-6 md:ml-0 w-[calc(100%-1.5rem)] md:w-4/5 lg:w-5/6 h-full overflow-y-auto p-4 items-center">
          ...
          <div className="flex flex-col p-4 rounded-lg bg-surface-a1">
            ...
            <Link
              to="/app/events"
              className="p-2 text-center bg-primary-a0 hover:bg-primary-a1 spooky:bg-spooky-a0 spooky:hover:bg-spooky-a1 space:bg-space-a0 space:hover:bg-space-a1 rounded-lg mt-2"
            >
              Back to events
            </Link>
          </div>
        ...
        >
          ...
          <p className="text-lg">
            ...
            <a
              ...
              className="text-primary-a0 spooky:text-spooky-a0 space:bg-space-a0 hover:underline break-all"
            >
          ...
          {!project && (
            <button
              type="submit"
              className="w-full bg-primary-a0 hover:bg-primary-a1 spooky:bg-spooky-a0 spooky:hover:bg-spooky-a1 space:bg-space-a0 space:hover:bg-space-a1 p-2 rounded-lg font-bold mt-2"
            >
              Create Project
            </button>
          )}
          {project && (
            <div className="flex flex-row w-full mt-2">
              <button
                type="submit"
                className="w-full bg-primary-a0 hover:bg-primary-a1 spooky:bg-spooky-a0 spooky:hover:bg-spooky-a1 space:bg-space-a0 space:hover:bg-space-a1 p-2 rounded-lg font-bold"
              >
                Save
              </button>
              <button
                ...
                className="w-full bg-primary-a0 hover:bg-primary-a1 spooky:bg-spooky-a0 spooky:hover:bg-spooky-a1 space:bg-space-a0 space:hover:bg-space-a1 p-2 rounded-lg font-bold ml-2"
              >
                Submit
              </button>
            </div>
